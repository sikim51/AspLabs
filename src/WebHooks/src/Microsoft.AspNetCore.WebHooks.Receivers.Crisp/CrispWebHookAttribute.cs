...
namespace Microsoft.AspNetCore.WebHooks
{
    /// <summary>
    /// <para>
    /// An <see cref="Attribute"/> indicating the associated action is a Crisp WebHook endpoint. Specifies the
    ...
    /// </para>
    /// <para>
    /// An example Crisp WebHook URI is
    /// '<c>https://{host}/api/webhooks/incoming/crisp/{id}?code=83699ec7c1d794c0c780e49a5c72972590571fd8</c>'.
    /// See <see href="https://help.crisp.chat/en/article/how-to-use-webhooks-itsagz/"/> for additional details about Crisp WebHook
    /// requests.
    /// </para>
    /// </summary>
    /// <remarks>
    ...
    /// </para>
    /// <para>
    /// <see cref="CrispWebHookAttribute"/> should be used at most once per <see cref="WebHookAttribute.Id"/> in a
    /// WebHook application.
    /// </para>
    /// </remarks>
    public class CrispWebHookAttribute : WebHookAttribute
    {
        /// <summary>
        /// Instantiates a new <see cref="CrispWebHookAttribute"/> indicating the associated action is a Crisp
        /// Alert WebHook endpoint.
        /// </summary>
        public CrispWebHookAttribute()
