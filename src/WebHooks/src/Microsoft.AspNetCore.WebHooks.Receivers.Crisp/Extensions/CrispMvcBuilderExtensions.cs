...
{
    /// <summary>
    /// Extension methods for setting up Crisp WebHooks in an <see cref="IMvcBuilder" />.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static class CrispMvcBuilderExtensions
    {
        /// <summary>
        /// <para>
        ...
        public static IMvcBuilder AddCrispWebHooks(this IMvcBuilder builder)
        {
            if (builder == null)
            {
